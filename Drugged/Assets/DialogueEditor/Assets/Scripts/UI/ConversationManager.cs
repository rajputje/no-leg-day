...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        //////////Modified////////////////////////////
        /// <summary>
        /// Shows full dialog or shows next dialog depending on current state
        /// </summary>
        public void ContinueDialog()
        {
            if (m_state == eState.ScrollingText)
            {
                Instance.DialogueText.maxVisibleCharacters = Instance.m_targetScrollTextCount;
                SetState(eState.Idle);
            }
            else if (m_state == eState.Idle)
                Instance.PressSelectedOption();
        }
        //////////////////////////////////////////
        ...
        ////////////////////// Modified//////////////
        public void ChangeDialogBoxWidth(float width)
        {
            ConversationManager.Instance.DialoguePanel.sizeDelta = new Vector2(width, ConversationManager.Instance.DialoguePanel.sizeDelta.y);
        }

        public void ChangeDialogBoxHeight(float height)
        {
            ConversationManager.Instance.DialoguePanel.sizeDelta = new Vector2(ConversationManager.Instance.DialoguePanel.sizeDelta.x, height);
        }
        ////////////////////////////////////////////
